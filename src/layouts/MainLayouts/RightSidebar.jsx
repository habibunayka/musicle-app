...
const RightSidebar = ({ currentSongIndex, songs }) => {
    ...
    return (
        <div className="relative hidden xl:flex flex-col overflow-x-auto pb-44 -mt-4 pl-2 pr-4 h-screen min-w-[360px] max-w-80 text-white">
            <div className="flex flex-col items-center px-4 mb-6">
                ...
                <div className="text-left w-full mt-4">
                    ...
                    <p className="text-slate-400 text-sm md:text-md">{currentSong.artist}</p>
                </div>
            </div>

            <div className="flex flex-col mt-2">
                <div className="flex flex-row justify-between px-4 mb-2">
                    <div className="text-slate-400 text-xs md:text-sm">Next in Queue</div>
                    <div className="text-primary text-xs md:text-sm cursor-pointer">
                        Show all
                    </div>
                </div>
